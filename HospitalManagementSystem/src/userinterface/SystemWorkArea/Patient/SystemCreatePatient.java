...
public class SystemCreatePatient extends javax.swing.JPanel {
    ...
    private boolean RegexValidation() {
        ...
        if(!txtAge.getText().matches("\\b\\d{2}\\b"))
        {
            txtAge.setBorder(BorderFactory.createLineBorder(Color.RED, 1));
            txtAge.setToolTipText("Please enter only numbers");
            validationCheck=false;
        }
        ...
        if(!txtHeight.getText().matches("([0-9]*[.]*[0-9])"))
        {
            ...
            txtHeight.setToolTipText("Please enter only numbers");
            validationCheck=false;
        }
        ...
        if(!txtWeight.getText().matches("([0-9]*[.]*[0-9])"))
        {
            ...
            txtWeight.setToolTipText("Please enter only numbers");
            validationCheck=false;
        }
